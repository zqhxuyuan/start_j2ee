Ext.onReady(function(){
    ...
    var url = {							// for this demo configure local and remote urls for demo purposes
        local:  'grid-filter.json',  	// static data file
        remote: 'grid-filter.php'		// remote access
    };
    var encode = false;					// configure whether filter query is encoded or not (initially)
    var local = true;					// configure whether filtering is performed locally or remotely (initially)

    store = new Ext.data.JsonStore({
        autoDestroy: true,				// store configs
    ...
    var filters = new Ext.ux.grid.GridFilters({
        ...
        filters: [{
            type: 'numeric',		//->ux/gridfilters/filter/NumericFilter.js
            dataIndex: 'id'
        }, {
            type: 'string',
            dataIndex: 'company',
