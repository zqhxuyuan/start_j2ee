Ext.onReady(function(){
	...
	// utilize custom extension for Hybrid Summary插件的好处是,只要更换别的插件,就可以达到另一种效果
    var summary = new Ext.ux.grid.HybridSummary();

    var grid = new xg.EditorGridPanel({
        ds: new Ext.data.GroupingStore({
            reader: reader,						// use json reader
            proxy : new Ext.data.HttpProxy({	// use remote data
                url: 'totals-hybrid.json',		// json data return
                method: 'GET'
            }),
