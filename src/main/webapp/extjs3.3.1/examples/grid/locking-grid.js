Ext.onReady(function(){
    ...
    var grid = new Ext.grid.GridPanel({
        store: store,
        colModel: new Ext.ux.grid.LockingColumnModel([		//1.列模式使用LockingColumnModel,不再是原先的ColumnModel
            {header: 'Company',      width: 160, sortable: true, dataIndex: 'company', locked: true, id:'company'}, 	//2.对要锁住的那一列设置locked: true
        ...
        view: new Ext.ux.grid.LockingGridView()			//3.视图采用扩展的LockingGridView
    });
