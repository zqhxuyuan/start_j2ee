Ext.onReady(function(){
    ...
    // Using checkbox/radio groups will generally be easier and more flexible than 使用复选框组或单选框组要
    ...
    var checkGroup = {
        ...
        items: [{
            ...
            // Use the default, automatic layout to distribute the controls evenly across a single row
            xtype: 'checkboxgroup',
